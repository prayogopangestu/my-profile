  ...
  const projects = [
    {
      ...
      description: 'A small e-commerce application built with Go, Fiber, PostgreSQL, and Kafka following Clean Architecture principles.',
    ...
    },
    {
      ...
      description: 'A full-featured budget tracker backend API built with Golang, Fiber, PostgreSQL, and Kafka following Clean Architecture principles.',
    ...
    },
    {
      ...
      description: 'A full-stack task management application built with Go, TypeScript, and PostgreSQL.',
    ...
    },
    {
      ...
      description: 'A full-featured e-commerce web application built with the MERN stack following clean architecture principles.',
      image: '/project-ecommerce.jpg',
    ...
    },
    {
      ...
      description: 'A full-stack platform designed to automate and streamline repetitive business processes through customizable workflows.',
      image: '/project-ai-dashboard.jpg',
    ...
    },
    {
      ...
      description: 'A comprehensive competitor pricing tracking system that monitors product prices and alerts users via Discord and Email.',
      image: '/project-taskapp.jpg',
      tags: ['TypeScript', 'Node.js', 'Web Scraping', 'API'],
      demoLink: '#',
      githubLink: 'https://github.com/prayogopangestu/Competitor-Pricing-Tracker',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        ...
        <div className="text-center mt-12">
          <Button
            ...
            onClick={() => window.open('https://github.com/prayogopangestu?tab=repositories', '_blank')}
          >
